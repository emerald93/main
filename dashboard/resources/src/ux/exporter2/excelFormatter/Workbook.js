/**
 * @class Ext.ux.exporter2.ExcelFormatter.Workbook
 * @extends Object
 * Represents an Excel workbook
 */
Ext.define("Ext.ux.exporter2.excelFormatter.Workbook", {
  ...
  constructor: function(config) {
    ...
    Ext.apply(this, config, {
       ...
       * @property styles
       * @type Array
       * The array of Ext.ux.exporter2.ExcelFormatter.Style objects attached to this workbook
       */
      styles: [],
       ...
       * @type Array
       * Array of all rendered Ext.ux.exporter2.ExcelFormatter.Style objects for this workbook
       */
      compiledStyles: [],
   ...
   * @return {Ext.ux.exporter2.ExcelFormatter.Worksheet} The worksheet
   */
  addWorksheet: function(store, config) {
    var worksheet = new Ext.ux.exporter2.excelFormatter.Worksheet(store, config);
  ...
  /**
   * Adds a new Ext.ux.exporter2.ExcelFormatter.Style to this Workbook
   * @param {Object} config The style config, passed to the Style constructor (required)
   */
  addStyle: function(config) {
    var style = new Ext.ux.exporter2.excelFormatter.Style(config || {});
