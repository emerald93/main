 ...
 */
Ext.define("Ext.ux.exporter2.excelFormatter.Style", {
  constructor: function(config) {
    ...
    Ext.ux.exporter2.excelFormatter.Style.superclass.constructor.apply(this, arguments);
