 ...
 */
Ext.define("Ext.ux.exporter2.Exporter", {
    uses: [
        "Ext.ux.exporter2.Base64",
        "Ext.ux.exporter2.Button",
        "Ext.ux.exporter2.csvFormatter.CsvFormatter",
        "Ext.ux.exporter2.excelFormatter.ExcelFormatter"
    ],
    ...
    statics: {
        ...
        getFormatterByName: function(formatter) {
            ...
            formatter = !Ext.isString(formatter) ? formatter : Ext.create("Ext.ux.exporter2." + formatter + "Formatter." + Ext.String.capitalize(formatter) + "Formatter");
            return formatter;
        }
    }
});