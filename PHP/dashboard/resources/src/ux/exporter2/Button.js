 ...
 * new Ext.ux.exporter2.Button({component: someGrid});
 * new Ext.ux.exporter2.Button({store: someStore});
 ...
 */
Ext.define("Ext.ux.exporter2.Button", {
    ...
    constructor: function(config) {
      ...
      this.initConfig();
      Ext.ux.exporter2.Button.superclass.constructor.call(this, config);
    ...
    setDownloadify: function(config) {
        ...
        Downloadify.create(this.el.down('p').id,{
            filename: function() {
              return self.getDownloadName() + "." + Ext.ux.exporter2.Exporter.getFormatterByName(self.formatter).extension;
            },
            data: function() {
              return Ext.ux.exporter2.Exporter.exportAny(self.component, self.formatter, config);
            },
            transparent: false,
            swf: this.getSwfPath(),
