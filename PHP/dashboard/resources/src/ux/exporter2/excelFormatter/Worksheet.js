/**
 * @class Ext.ux.exporter2.ExcelFormatter.Worksheet
 * @extends Object
 * Represents an Excel worksheet
 * @cfg {Ext.data.Store} store The store to use (required)
 */
Ext.define("Ext.ux.exporter2.excelFormatter.Worksheet", {
  ...
  constructor: function(store, config) {
    ...
    Ext.ux.exporter2.excelFormatter.Worksheet.superclass.constructor.apply(this, arguments);
  },
  ...
  buildCell: function(value, type, style) {
    ...
    return new Ext.ux.exporter2.excelFormatter.Cell({
      value: value,
      type : type,
      style: style
    });
